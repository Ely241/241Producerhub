  ...
  return (
    ...
    >
      <div className="container mx-auto px-4 py-2">
        <div className="flex flex-wrap items-center justify-between gap-4"> {/* Added flex-wrap */}
          <div className="flex items-center gap-4 flex-grow"> {/* Track Info */}
          ...
          {/* Group central controls for better wrapping */}
          <div className="flex flex-wrap items-center justify-center gap-2 md:gap-4 flex-grow-0"> {/* Added flex-wrap, adjusted gap */}
            <div className="flex items-center gap-2"> {/* Playback Controls */}
              ...
              <Button onClick={toggleFullScreen} size="icon" variant="secondary" className="text-muted-foreground hover:text-foreground"> {/* Moved and changed variant */}
                  <Maximize2 className="w-5 h-5" />
              </Button>
            </div>

            <div className="flex-grow-0 flex-shrink-0 w-full md:w-64"> {/* Progress Bar */}
